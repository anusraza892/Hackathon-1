...
export default function BlueHeader() {
  return (
    <div className="lg:w-[1437px] lg:block hidden w-full h-[58px] bg-[#252B42]">
  <div className="flex justify-between items-center w-full h-full px-[24px]">
    ...
    <div className="flex gap-[10px]">
      <button className="flex items-center gap-[5px] p-[10px] text-white">
        ...
        <span className="font-Montserrat font-semibold text-[14px]"> (92) 0319 3318526</span>
      </button>
      <button className="flex items-center gap-[5px] p-[10px] text-white rounded-[5px]">
        <Image src={mail} alt="mail" width={16} height={16} />
        <span className="font-Montserrat text-[14px]">syedanus695@mail.com</span>
      </button>
    </div>
