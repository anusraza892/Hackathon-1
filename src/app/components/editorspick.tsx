...
<div className="w-full flex justify-center py-[10px] absolute top-[850px] bg-[#f5f5f5]">
  <div className="w-[1050px] h-auto flex flex-col gap-[30px] bg-[#FAFAFA] p-[40px]">
    ...
    <div className="flex flex-col items-center gap-[10px]">
      <h3 className="font-Montserrat font-semibold text-[24px] leading-[32px]">EDITOR’S PICK</h3>
    ...
    <div className="w-full h-[500px] flex gap-[30px]">
      ...
      <div className="relative w-[510px] h-[500px]">
        <Image src={Men} alt="men" className="w-full h-full object-cover rounded-md" />
      ...
      <div className="relative w-[240px] h-[500px]">
        <Image src={women} alt="women" className="w-full h-full object-cover" />
      ...
      <div className="w-[240px] h-[500px] flex flex-col gap-[30px]">
        ...
        <div className="relative w-[240px] h-[242px]">
          <Image src={div1} alt="div1" className="w-full h-full object-cover" />
          <button className="absolute top-[180px] left-[20px] w-[136px] h-[48px] px-[24px] py-[12px] flex items-center justify-center gap-[10px] bg-white shadow-md">
            <h2 className="font-Montserrat font-bold text-[16px] leading-[24px] text-[#252B42]">ACCESSORIES</h2>
          </button>
        </div>
        {/* Kids Image */}
        <div className="relative w-[240px] h-[242px]">
          <Image src={div2} alt="div2" className="w-full h-full object-cover" />
          <button className="absolute top-[180px] left-[20px] w-[136px] h-[48px] px-[24px] py-[12px] flex items-center justify-center gap-[10px] bg-white shadow-md">
            <h2 className="font-Montserrat font-bold text-[16px] leading-[24px] text-[#252B42]">KIDS</h2>
          </button>
        </div>
      </div>
    </div>
